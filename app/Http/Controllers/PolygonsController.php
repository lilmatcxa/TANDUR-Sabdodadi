...
class PolygonsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $geomWKT = $request->geom_polygon;
        $areaResult = DB::selectOne("SELECT ST_Area(ST_GeomFromText(?, 4326)::geography)/10000 as area_ha", [$geomWKT]);
        $areaHa = $areaResult->area_ha;
        // Simpan data
        $data = [
